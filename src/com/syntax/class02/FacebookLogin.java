...
public class FacebookLogin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.partialLinkText("Forgot Password?")).click();//using partial link is preferred when there is change in the info, whenever webpage refreshes
