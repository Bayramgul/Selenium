...
public class HW_xpath {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='userName']")).sendKeys("gul124@gmail.com");// xpath with id attribute
		...
		driver.findElement(By.xpath("//input[@name='email']")).sendKeys("gul124@gmail.com");
